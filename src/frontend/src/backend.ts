...
import type { ContactMessage as _ContactMessage, ExternalBlob as _ExternalBlob, Order as _Order, OrderStatus as _OrderStatus, ProductSize as _ProductSize, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitContactMessage(arg0: ContactMessage): Promise<ContactId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactMessage(to_candid_ContactMessage_n26(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOrder(arg0: Order): Promise<OrderId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOrder(await to_candid_Order_n28(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ContactMessage_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ContactMessage): ContactMessage {
...
async function from_candid_Order_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Order): Promise<Order> {
    return await from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_ProductSize_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductSize): ProductSize {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        productSize: from_candid_ProductSize_n19(_uploadFile, _downloadFile, value.productSize),
        logoBlob: record_opt_to_undefined(await from_candid_opt_n21(_uploadFile, _downloadFile, value.logoBlob)),
        email: value.email,
...
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? OrderStatus.pending : "fulfilled" in value ? OrderStatus.fulfilled : "confirmed" in value ? OrderStatus.confirmed : value;
}
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "_500ml" in value ? ProductSize._500ml : "_1000ml" in value ? ProductSize._1000ml : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ContactMessage>): Array<ContactMessage> {
    return value.map((x)=>from_candid_ContactMessage_n11(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Order>): Promise<Array<Order>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Order_n15(_uploadFile, _downloadFile, x)));
}
function to_candid_ContactMessage_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ContactMessage): _ContactMessage {
...
async function to_candid_Order_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Order): Promise<_Order> {
    return await to_candid_record_n29(_uploadFile, _downloadFile, value);
}
function to_candid_ProductSize_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductSize): _ProductSize {
...
async function to_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        deliveryAddress: value.deliveryAddress,
        productSize: to_candid_ProductSize_n32(_uploadFile, _downloadFile, value.productSize),
        logoBlob: value.logoBlob ? candid_some(await to_candid_ExternalBlob_n34(_uploadFile, _downloadFile, value.logoBlob)) : candid_none(),
        email: value.email,
        colorPreferences: value.colorPreferences,
        timestamp: value.timestamp,
        customText: value.customText,
...
function to_candid_variant_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductSize): {
    _500ml: null;
} | {
    _1000ml: null;
} {
    return value == ProductSize._500ml ? {
        _500ml: null
    } : value == ProductSize._1000ml ? {
        _1000ml: null
    } : value;
}
